...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-video-dynamic-range
 */
public class MediaVideoDynamicRange extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"standard", "high"};
    ...
    /**
     * Create a new MediaVideoDynamicRange
     */
    public MediaVideoDynamicRange() {
    }
     ...
     */
    public MediaVideoDynamicRange(ApplContext ac, String modifier,
    ...
    public MediaVideoDynamicRange(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaVideoDynamicRange mo = (MediaVideoDynamicRange) other;
