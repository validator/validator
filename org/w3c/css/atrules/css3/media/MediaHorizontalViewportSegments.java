...
/**
 * @spec https://www.w3.org/TR/2021/WD-mediaqueries-5-20211218/#descdef-media-horizontal-viewport-segments
 */
public class MediaHorizontalViewportSegments extends MediaRangeFeature {

    /**
     * Create a new MediaHorizontalViewportSegments
     */
    public MediaHorizontalViewportSegments() {
    }
     ...
     */
    public MediaHorizontalViewportSegments(ApplContext ac, String modifier,
    ...
    public MediaHorizontalViewportSegments(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaHorizontalViewportSegments mm = (MediaHorizontalViewportSegments) other;
