...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-dynamic-range
 */
public class MediaDynamicRange extends MediaFeature {
    ...
    /**
     * Create a new MediaDynamicRange
     */
    public MediaDynamicRange() {
    }
     ...
     */
    public MediaDynamicRange(ApplContext ac, String modifier,
    ...
    public MediaDynamicRange(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaDynamicRange mo = (MediaDynamicRange) other;
