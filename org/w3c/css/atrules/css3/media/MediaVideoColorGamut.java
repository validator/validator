...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-video-color-gamut
 */
public class MediaVideoColorGamut extends MediaFeature {
    ...
    /**
     * Create a new MediaVideoColorGamut
     */
    public MediaVideoColorGamut() {
    }
     ...
     */
    public MediaVideoColorGamut(ApplContext ac, String modifier,
    ...
    public MediaVideoColorGamut(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaVideoColorGamut mo = (MediaVideoColorGamut) other;
