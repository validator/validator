...
public class CssUnicodeRange extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.fontFaceCssUnicodeRange != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssUnicodeRange &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getFontFaceCssUnicodeRange();
        } else {
            return ((Css3Style) style).fontFaceCssUnicodeRange;
        }
    }
}
