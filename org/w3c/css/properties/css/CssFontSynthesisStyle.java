...
public class CssFontSynthesisStyle extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.cssFontSynthesisStyle != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFontSynthesisStyle &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getFontSynthesisStyle();
        } else {
            return ((Css3Style) style).cssFontSynthesisStyle;
        }
    }
}
