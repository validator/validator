...
public class CssOrientation extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.viewportCssOrientation != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssOrientation &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getViewportOrientation();
        } else {
            return ((Css3Style) style).viewportCssOrientation;
        }
    }
}
