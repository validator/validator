...
using them.
   ...
   [16]: https://github.com/validator/validator.github.io/releases/latest
...
#### nu.validator.client.parser
    ...
    possible values: see
    [wiki.whatwg.org/wiki/Validator.nu_Common_Input_Parameters#parser][23]

   [23]: https://wiki.whatwg.org/wiki/Validator.nu_Common_Input_Parameters#parser
...
#### nu.validator.client.out
    ...
    possible values: see
    [wiki.whatwg.org/wiki/Validator.nu_Common_Input_Parameters#out][24]

   [24]: https://wiki.whatwg.org/wiki/Validator.nu_Common_Input_Parameters#out
