...
package org.w3c.css.properties.css.fontpalettevalues;
...
public class CssOverrideColors extends CssProperty {
    ...
    /**
     * Creates a new CssOverrideColors
     *
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.fontPaletteValuesCssOverrideColors != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssOverrideColors &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getFontPaletteValuesCssOverrideColors();
        } else {
            return ((Css3Style) style).fontPaletteValuesCssOverrideColors;
        }
    }
}
