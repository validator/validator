...
public class CssBasePalette extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        ...
        if (s.fontPaletteValuesCssBasePalette != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssBasePalette &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getFontPaletteValuesCssBasePalette();
        } else {
            return ((Css3Style) style).fontPaletteValuesCssBasePalette;
        }
    }
}
