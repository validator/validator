...
public class CssContainIntrinsicSize extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css3Style) style).cssContainIntrinsicSize != null)
            style.addRedefinitionWarning(ac, this);
        ((Css3Style) style).cssContainIntrinsicSize = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssContainIntrinsicSize &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css3Style) style).getContainIntrinsicSize();
        } else {
            return ((Css3Style) style).cssContainIntrinsicSize;
        }
    }
}
