...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-prefers-reduced-transparency
 */
public class MediaPrefersReducedTransparency extends MediaFeature {
    ...
    /**
     * Create a new MediaPrefersReducedTransparency
     */
     ...
     */
    public MediaPrefersReducedTransparency(ApplContext ac, String modifier,
    ...
    public MediaPrefersReducedTransparency(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaPrefersReducedTransparency mo = (MediaPrefersReducedTransparency) other;
