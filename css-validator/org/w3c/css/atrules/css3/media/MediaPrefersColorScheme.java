...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-prefers-color-scheme
 */
public class MediaPrefersColorScheme extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"light", "dark"};
    ...
    /**
     * Create a new MediaPrefersColorScheme
     */
    public MediaPrefersColorScheme() {
    }
     ...
     */
    public MediaPrefersColorScheme(ApplContext ac, String modifier,
    ...
    public MediaPrefersColorScheme(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaPrefersColorScheme mo = (MediaPrefersColorScheme) other;
