...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-inverted-colors
 */
public class MediaInvertedColors extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"none", "inverted"};
    ...
    /**
     * Create a new MediaInvertedColors
     */
    public MediaInvertedColors() {
    }
     ...
     */
    public MediaInvertedColors(ApplContext ac, String modifier,
    ...
    public MediaInvertedColors(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaInvertedColors mo = (MediaInvertedColors) other;
