...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-forced-colors
 */
public class MediaForcedColors extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"none", "active"};
    ...
    /**
     * Create a new MediaForcedColors
     */
    public MediaForcedColors() {
    }
     ...
     */
    public MediaForcedColors(ApplContext ac, String modifier,
    ...
    public MediaForcedColors(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaForcedColors mo = (MediaForcedColors) other;
