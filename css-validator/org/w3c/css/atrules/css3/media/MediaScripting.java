...
/**
 * @spec https://www.w3.org/TR/2020/WD-mediaqueries-5-20200731/#descdef-media-scripting
 */
public class MediaScripting extends MediaFeature {

    public static final CssIdent[] allowed_values;

    static {
        String[] _allowed_values = {"none", "initial-only", "enabled"};
    ...
    /**
     * Create a new MediaScripting
     */
    public MediaScripting() {
    }
     ...
     */
    public MediaScripting(ApplContext ac, String modifier,
    ...
    public MediaScripting(ApplContext ac, String modifier, CssExpression expression)
            throws InvalidParamException {
    ...
    public boolean equals(MediaFeature other) {
        try {
            MediaScripting mo = (MediaScripting) other;
