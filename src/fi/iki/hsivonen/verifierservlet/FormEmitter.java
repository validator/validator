...
__attrs__.clear();
__attrs__.addAttribute("", "title", "title", "CDATA", "IRI (http or https) of the document to be checked. (Leave blank to bookmark settings.)");
...
contentHandler.endElement("http://www.w3.org/1999/xhtml", "tr", "tr");
__attrs__.clear();
__attrs__.addAttribute("", "title", "title", "CDATA", "The parser to use. This selection also affect the Accept HTTP request header that is sent. The HTML 4.01 parser options mean the HTML5 parser in a compatibility mode\u2014not an SGML parser.");
contentHandler.startElement("http://www.w3.org/1999/xhtml", "tr", "tr", __attrs__);
__attrs__.clear();
contentHandler.startElement("http://www.w3.org/1999/xhtml", "th", "th", __attrs__);
__attrs__.clear();
