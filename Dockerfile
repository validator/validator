...
ADD https://github.com/validator/validator/releases/download/jar/vnu.jar .
ADD https://github.com/validator/validator/releases/download/jar/vnu.jar.asc .
ADD https://github.com/validator/validator/releases/download/jar/vnu.jar.sha1 .
ADD https://github.com/validator/validator/releases/download/jar/vnu.jar.sha1.asc .
RUN apk --no-cache add gnupg
RUN gpg --quiet --keyserver ha.pool.sks-keyservers.net --recv-keys 100025026C976B92 || \
